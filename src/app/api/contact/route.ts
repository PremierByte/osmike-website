...
export async function POST(req: Request) {
  try {
    ...
    // 1. Dynamic UI Accents matching the brand theme
    const primaryColor = "#0A1229"; // Deep premium midnight navy
    const secondaryColor = "#dc3545"; // Vibrant accent red
    const backgroundColor = "#f4f6fc";
    ...
    const htmlEmailTemplate = `
      ...
      <head>
        ...
        <style>
          ...
          .icon { color: ${secondaryColor}; font-size: 20px; }
        </style>
      </head>
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="card">
              ...
              <div class="value" style="font-size: 18px; color: ${primaryColor};">${name}</div>
            </div>
            <div class="card">
    ...
    const fromEmail = process.env.SMTP_USER || "noreply@vantage-agency.com";
